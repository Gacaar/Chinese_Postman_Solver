...
two_bits = [
    (1,2,1, True), (2,1,1, True), (1,3,1, True), (3,1,1, True), (2,4,1, True),
    (4,2,1, True), (3,4,1, True),  (4,3,1, True)
]

three_bits = [
    (1,2,1, True), (2,1,1, True),
    (1,3,1, True), (3,1,1, True),
    (1,5,1, True), (5,1,1, True), 
    (2,4,1, True), (4,2,1, True),
    (2,6,1, True), (6,2,1, True), 
    (3,4,1, True),  (4,3,1, True),
    (3,7,1, True),  (7,3,1, True),
    (8,4,1, True),  (4,8,1, True),
    (7,5,1, True),  (5,7,1, True),
    (7,8,1, True),  (8,7,1, True),
    (6,8,1, True),  (8,6,1, True),
    (5,6,1, True),  (6,5,1, True)
]
...
four_bits = [
    ...
    (1,3,1, True), (3,1,1, True),
    (1,5,1, True), (5,1,1, True),
    (1,9,1, True), (9,1,1, True),
    (2,4,1, True), (4,2,1, True),
    (2,6,1, True), (6,2,1, True),
    (2,10,1, True), (10,2,1, True),
    (3,4,1, True),  (4,3,1, True),
    (3,7,1, True),  (7,3,1, True),
    (3,11,1, True),  (11,3,1, True),
    (8,4,1, True),  (4,8,1, True),
    (12,4,1, True),  (4,12,1, True),
    (7,5,1, True),  (5,7,1, True),
    (7,8,1, True),  (8,7,1, True),
    (7,15,1, True),  (15,7,1, True),
    (5,6,1, True),  (6,5,1, True),
    (6,8,1, True),  (8,6,1, True),
    (16,8,1, True),  (8,16,1, True),
    (6,14,1, True),  (14,6,1, True),
    (5,13,1, True),  (13,5,1, True),
    (13,14,1, True),  (14,13,1, True),
    (13,9,1, True),  (9,13,1, True),
    (13,15,1, True),  (15,13,1, True),
    (16,14,1, True),  (14,16,1, True),
    (10,14,1, True),  (14,10,1, True),
    (15,16,1, True),  (16,15,1, True),
    (12,16,1, True),  (16,12,1, True),
    (11,15,1, True),  (15,11,1, True),
    (11,12,1, True),  (12,11,1, True),
    (11,9,1, True),  (9,11,1, True),
    (10,12,1, True),  (12,10,1, True),
    (10,9,1, True),  (9,10,1, True)
]
...
FFD = [
    ...
    (1,3,1, True), (3,1,1, True),
    (3,7,1, True), (7,3,1, True), 
    (4,8,1, True),  (8,4,1, True),
    (8,6,1, True),  (6,8,1, True),
    (6,2,1, True),  (2,6,1, True),
    (7,5,1, True),
    (2,3,1, True), 
    (4,2,1, True)
]